    ...
    <div>
      ...
      >
        <div className="max-w-screen-2xl ">
          <div className="grid grid-cols-1 px-4 sm:px-6 lg:px-8 gap-8 py-10 lg:grid-cols-3 ">
            <div classNameName="items-center justify-between">
              ...
              <div className="flex mt-8 space-x-6 text-blue-300 ">
                <Link
                  to="https://www.facebook.com/profile.php?id=100085099856228"
                ...
                <Link
                  to="https://www.instagram.com/tehseenjafar?igsh=YWk0ZmNvNjZ3bDI="
                  className="hover:opacity-75"
                  target="_blank"
                  rel="noreferrer"
                >
                ...
                <Link
                  className="hover:opacity-75"
                  to="https://github.com/Babar-amjad/electrolysis"
                  target="_blank"
                  rel="noreferrer"
                >
          ...
          <div className="w-full text-white bg-orange-500 mt-4">
